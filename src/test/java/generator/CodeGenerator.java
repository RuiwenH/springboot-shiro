...
public class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/shiro_test?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC";
    ...
    public static void main(String[] args) {
		...
		genCodeByCustomModelName("t_role", "SysRole");
		genCodeByCustomModelName("t_permission", "SysPermission");
		genCodeByCustomModelName("t_user_role", "UserRole");
		genCodeByCustomModelName("t_role_permission", "SysRolePermission");
